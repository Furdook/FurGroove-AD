...
export default function Navigation() {
  ...
  return (
    <nav
      id="nav"
      className="fixed z-20 w-screen bg-primary-900/70 backdrop-blur transition-transform duration-300"
    >
      <Hamburger />
      <ul
        id="menu"
        className="my-auto mr-6 hidden h-screen flex-col justify-center gap-8 text-right tracking-widest lg:mx-auto lg:mt-0 lg:flex lg:h-12 lg:w-screen lg:max-w-4xl lg:flex-row lg:justify-around lg:bg-opacity-0 lg:pt-2"
      >
  ...
  return (
    <>
      <img
        src="/logo.webp"
        alt="FurGroove logo"
        className="mx-auto h-14 lg:hidden"
      />
      <label
